...
app.register(require('fastify-rate-limit'), {
  max: +process.env.MAX_CONNECTION_PER_MINUTE || 10000000,
  timeWindow: '1 minute'
});
...
//claim
app.register(require('./routes/cl_ipds'), { prefix: '/v1/cl-ipds', logger: true });
app.register(require('./routes/cl_ipd_reps'), { prefix: '/v1/cl-ipd-reps', logger: true });

//appointment
app.register(require('./routes/oapp'), { prefix: '/v1/oapp', logger: true });
app.register(require('./routes/oapp_slot'), { prefix: '/v1/oapp-slot', logger: true });

//line
app.register(require('./routes/line_token'), { prefix: '/v1/line-token', logger: true });
//app.register(require('./routes/oapp_slot'), { prefix: '/v1/oapp-slot', logger: true });
